namespace WebOrder.DAL.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        MealType = c.Int(nullable: false),
                        MinimalOrder = c.Double(nullable: false),
                        Rating = c.Double(nullable: false),
                        IsOpen = c.Boolean(nullable: false),
                        AverageDeliveryTime = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        WorkingHoursStart = c.DateTime(nullable: false),
                        WorkingHoursEnd = c.DateTime(nullable: false),
                        DayOfWeek = c.String(),
                        RestaurantId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Meals", "Order_Id", "dbo.Orders");
            DropForeignKey("dbo.Meals", "RestaurantId", "dbo.Restaurants");
            DropForeignKey("dbo.WorkDays", "RestaurantId", "dbo.Restaurants");
